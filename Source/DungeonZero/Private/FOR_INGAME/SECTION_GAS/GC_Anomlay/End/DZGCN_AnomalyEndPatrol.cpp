...
#include "FOR_INGAME/SECTION_GAS/GC_Anomlay/End/DZGCN_AnomalyEndPatrol.h"
#include "FOR_INGAME/SECTION_ANOMALY/Interface/DZAnomalySealAdditionalFunction.h"
#include "Kismet/GameplayStatics.h"

ADZGCN_AnomalyEndPatrol::ADZGCN_AnomalyEndPatrol()
{
	PrimaryActorTick.bCanEverTick = false;
}

bool ADZGCN_AnomalyEndPatrol::OnExecute_Implementation(AActor* MyTarget, const FGameplayCueParameters& Parameters)
{
