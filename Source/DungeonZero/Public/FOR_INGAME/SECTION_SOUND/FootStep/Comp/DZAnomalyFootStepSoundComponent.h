...
#include "DZAnomalyFootStepSoundComponent.generated.h"


UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class DUNGEONZERO_API UDZAnomalyFootStepSoundComponent : public UDZFootStepSoundMasterComponent
{
	GENERATED_BODY()
...
public:
	UDZAnomalyFootStepSoundComponent();
