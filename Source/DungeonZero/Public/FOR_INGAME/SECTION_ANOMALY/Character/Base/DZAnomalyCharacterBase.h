...
#include "DZAnomalyCharacterBase.generated.h"
...
UCLASS()
class DUNGEONZERO_API ADZAnomalyCharacterBase : public ACharacter, public IAbilitySystemInterface, 
...
public:
	UFUNCTION()
	void OnHitGround_Internal(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit);
