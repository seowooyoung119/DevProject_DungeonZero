...
#include "DZAnomalyController.generated.h"


UCLASS()
class DUNGEONZERO_API ADZAnomalyController : public AAIController, public IDZAnomalySealAdditionalFunction
{
	GENERATED_BODY()
...
public:
	ADZAnomalyController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
