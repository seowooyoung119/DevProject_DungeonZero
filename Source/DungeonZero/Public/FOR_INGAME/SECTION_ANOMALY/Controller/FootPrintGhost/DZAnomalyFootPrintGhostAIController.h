...
#include "DZAnomalyFootPrintGhostAIController.generated.h"

UCLASS()
class DUNGEONZERO_API ADZAnomalyFootPrintGhostAIController : public ADZAnomalyController
{
	GENERATED_BODY()
...
public:
	ADZAnomalyFootPrintGhostAIController();
